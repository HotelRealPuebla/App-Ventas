...
class DataBaseHelper {
  var status;
  var token;
  //String serverUrlproducts = "http://192.168.1.87:3000/products";
...
/*
  ...
  void addDataProducto(String _nameController, String _priceController,
    ...
    //String myUrl = "http://192.168.1.87:3000/products";
    final myUrl =
        Uri(scheme: 'https', host: 'hotel-rp.vercel.app', path: '/api/eventos');
  ...
  void editarProduct(
    ...
    //String myUrl = "http://192.168.1.87:3000/product/$_id";
    final myUrl =
        Uri(scheme: 'https', host: 'hotel-rp.vercel.app', path: '/api/eventos');
    http.put(myUrl, body: {
      "name": "$name",
  ...
  Future<void> removeRegister(String _id) async {
    ...
    final myUrl = Uri(
        scheme: 'https',
        host: 'hotel-rp.vercel.app',
        path: '/api/eventos/$_id');
